...
export default function PublicProfileClient({ params }: Props) {
        ...
        >
          <div className="p-8 md:p-12 text-center">
            <div className="mb-4">
              ...
              >
                <svg className="w-8 h-8" fill="none" stroke="#FFFFFF" viewBox="0 0 24 24" strokeWidth={2.5}>
            ...
            <p className="mb-8 max-w-xl mx-auto" style={{ fontSize: '17px', color: '#5E6370', lineHeight: '1.6' }}>
              {profile.full_name} is available for brand partnerships, sponsored content, and creative collaborations.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a
                href={`mailto:${profile.email}?subject=Partnership Opportunity with ${profile.full_name}`}
                className="inline-flex items-center gap-2 px-8 py-4 text-white font-semibold transition-all cursor-pointer"
                style={{
                  background: 'linear-gradient(135deg, #FD8AE6 0%, #C77DFF 100%)',
                  borderRadius: '12px',
              ...
              {profile.instagram_handle && (
                <a
                  ...
                  className="inline-flex items-center gap-2 px-8 py-4 font-semibold transition-all cursor-pointer"
                  style={{
                    background: '#F8F9FB',
                    color: '#0C0F1A',
                    borderRadius: '12px',
